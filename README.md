<!-- Rafael SILVA — DEVIMPLOY PROFILE README -->
<!-- Futuristic cyberpunk-inspired GitHub profile -->
...
║    ╚═════╝ ╚══════╝  ╚═══╝  ╚═╝╚═╝     ╚═╝╚═╝      ╚══════╝ ║
║                                                              ║
║         [ INICIANDO SISTEMA... CARREGANDO PERFIL ]          ║
╚══════════════════════════════════════════════════════════════╝
```
...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=00F7FF&center=true&vCenter=true&width=600&lines=AppSheet+Developer+%7C+No-Code+Expert;Founder+%40+Devimploy;Google+Partner+Oficial;Transformando+processos+em+sistemas;Projetos+em+4+pa%C3%ADses+%F0%9F%8C%8E;TypeScript+%7C+Claude+AI+%7C+MCP+Protocol)
...
![Profile Views](https://komarev.com/ghpvc/?username=devimploy&color=00f7ff&style=for-the-badge&label=VISITANTES+DO+PERFIL)
...
Nome:         Rafael Silva
Handle:       @devimploy
OS:           AppSheet + No-Code Runtime v5.0
Empresa:      Devimploy (Fundador)
Certificação: Google AppSheet Partner Oficial
Experiência:  15 anos em TI | 5+ anos em No-Code/SaaS
Alcance:      Brasil · Portugal · Suíça · EUA 🌎
Atualmente:   Construindo SaaS para Petshops, Barbearias e Guincho
...
| Sistema | Setor | Stack | Status |
|---|---|---|---|
| 🐾 **PetShop SaaS** | Petshops | AppSheet + Google Sheets | 🟢 Live |
| 🚗 **GrinchoApp** | Guincho/Frotas | AppSheet + TypeScript | 🟢 Live |
| 💈 **BarbeariaApp** | Barbearias | AppSheet + Automations | 🟡 Beta |
| 🤖 **ASAAS MCP Server** | FinTech / IA | TypeScript + Claude AI | 🟢 Live |
| 🎵 **ChordShift** | Música | HTML + JS | 🟢 Live |
| 🌾 **AgroShop PDV** | Agronegócio | AppSheet + SQL | 🟢 Live |
| 📋 **Reboq360** | Captação | HTML + JS | 🟡 Dev |
...
![MCP](https://img.shields.io/badge/MCP_Protocol-00C4CC?style=for-the-badge&logo=data&logoColor=white)
...
![GitHub Trophy](https://github-profile-trophy.vercel.app/?username=devimploy&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=6)
...
*Auto-atualizado via GitHub Actions · Última atualização: 2026*
